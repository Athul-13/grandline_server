...
import { createDriverRoutesWithDI } from '../../../presentation/routes/driver/driver_routes';
...
export class App {
  ...
  public registerRoutes(): void {
    ...
    const driverRoutes = createDriverRoutesWithDI();
    this.app.use(`/api/v1/driver`, driverRoutes);
